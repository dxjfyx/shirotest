package com.shiroboot.shirotest.utils;
...
public final class EndecryptUtils {
     ...
     * @return 密文和salt
     */
    public static TabUser md5Password(String username,String password){
        ...
        user.setColPassword(password_cipherText);
        user.setColSalt(salt);
        user.setColName(username);
        return user;
    }
     ...
     * @return 密文和salt
     */
    public static TabUser md5Password2(String username,String password){
        Preconditions.checkArgument(!Strings.isNullOrEmpty(username),"username不能为空");
        Preconditions.checkArgument(!Strings.isNullOrEmpty(password),"password不能为空");
        SecureRandomNumberGenerator secureRandomNumberGenerator=new SecureRandomNumberGenerator();
        String salt= secureRandomNumberGenerator.nextBytes().toHex();
